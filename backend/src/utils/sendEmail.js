...
const sendEmail = async (to, subject, text, otpCode) => {
  ...
  <body>
    <div class="email-container">
      ...
      <div class="content">
        ...
        <p>Welcome to <span class="highlight">LiveLine</span> – where innovation meets simplicity. We're here to make your digital journey smooth and secure.</p>
        ...
        <div class="otp-box">
          ...
          <p style="margin: 10px 0 0; font-size: 12px; opacity: 0.7;">Expires in 5 minutes</p>
        </div>
        ...
        <p>Stay secure,<br>The <span class="highlight">LiveLine</span> Team</p>
      </div>
  ...
  const mailOptions = {
    from: `"LiveLine" <${process.env.EMAIL_USER}>`,
    to,
    subject: subject || "Your LiveLine OTP Code",
